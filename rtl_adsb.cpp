...
static inline int preamble(const uint16_t *buf, int i) // ori: uint16_t *buf
...
void messages(const uint16_t *buf, int len) // no const
{
...
//    int dev_given = 0;
    ...
    pthread_create(&demod_thread, nullptr, demod_thread_fn, (void *)nullptr);
    rtlsdr_read_async(dev, rtlsdr_callback, (void *)nullptr,
    ...
    pthread_join(demod_thread, nullptr);
